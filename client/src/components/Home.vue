      ...
      <div class="card-header">
        ...
        <div>
          <b-navbar toggleable="lg" type="dark" variant="dark">
            <b-navbar-brand @click="getPosts">Posts</b-navbar-brand>
            ...
            <b-collapse id="nav-collapse" is-nav>
              ...
              <b-navbar-nav class="ml-auto">
                <b-form-input
                  ...
                  placeholder="Search"
                ></b-form-input>
                <b-button size="sm" @click="search()" class="my-2 my-sm-0"
                  >Search</b-button
                >
      ...
      <div class="card">
        <div class="row">
          <div v-for="post in posts" :key="post.id" class="col-md-4 jumbotron">
            ...
            <div class="card-body">
              <p>
                {{ post.postText ? post.postText.substring(0, 200) : ""
                }}{{
                  post.postText ? (post.postText.length > 200 ? "..." : "") : ""
                }}
              </p>
            </div>
